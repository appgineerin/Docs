...
![Screenshot: The application detail view with the "Update Available" button highlighted in the header and a small badge indicating the new version number.](/img/launcher/update-available.webp)
...
![Screenshot: The "Close App to Continue" dialog overlay with the app name, an explanation, and two buttons: "Close App" and "Cancel".](/img/launcher/close-to-update.webp)
